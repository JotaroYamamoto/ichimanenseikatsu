          ...
          <div class="add__top">
            <div class="add__top__left">
              ...
              <label for="file">
                <div class="add-img" >
                  ...
                  <br />
                  <input id="file" type="file" name="mainimg" value="{{$post->mainimg}}">
                </div>
              </label>
            </div>
            <div class="add__top__right">
              <div class="add-title">
                ...
                <input class="text-form inputA" type="text" name="title" value="{{$post->title}}">
              </div>
              <div class="add-text">
                <p class="textA">説明</p>
                <textarea class="text-form areaA" rows="10" name="text" >{{$post->text}}</textarea>
              </div>
            </div>
          </div>
          ...
          <div class="add__mid">
            ...
            <div class="add--cost">
              ...
              <div class="add--cost-form">
                <input class="add-input" type="text" name="cost" value="{{$post->cost}}"><span>円</span>
              </div>
            </div>
          </div>
